...
res0 <- sapply(2:5, function(i) as.numeric(as.data.frame(clinic_geneve[, date_vars[1]] - clinic_geneve[, date_vars[i]])[, 1]))
res <- sapply(seq(4), function(i) ifelse(abs(res0[, i]) > 7, NA, res0[, i]))
colnames(res) <- paste("inclusion - general biology", seq(4))
...
clinic_geneve <- cbind(clinic_geneve, res, temp) 
