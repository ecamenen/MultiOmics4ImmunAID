...
level0 <- get_levels0(l_level_cols, i_rows) -> haq_levels
# get_var_names(unlist(cols_sim[-i_rows]), haq_code[[3]])
level1 <- get_levels0(l_level_cols, -i_rows)

level_tot <- parse_levels0(level1)
