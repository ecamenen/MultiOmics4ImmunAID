...
codes %>%
    filter(str_detect(item_name, "Fever")) %>%
    filter(str_detect(group_code, "IMA_General_pyrexia"))
...
sys %>% filter(str_detect(item_name, "Treatment group|Date of beginning|Response|over|Treatment category|Every|Period"))
