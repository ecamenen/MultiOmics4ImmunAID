...
venn::venn(vars_tot, ilabels = TRUE, zcolor = "style")
# all included in clinic data
venn::venn(vars_tot2, ilabels = TRUE, zcolor = "style")
...
diagnose_category(
  clinic_code_proc[, "group_name", drop = FALSE], top = 100
) %>% arrange(freq)
